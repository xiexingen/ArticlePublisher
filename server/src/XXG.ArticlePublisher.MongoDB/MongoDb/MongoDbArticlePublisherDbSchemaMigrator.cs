...
{
    public class MongoDbArticlePublisherDbSchemaMigrator : IArticlePublisherDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbArticlePublisherDbSchemaMigrator(IServiceProvider serviceProvider)
        {
