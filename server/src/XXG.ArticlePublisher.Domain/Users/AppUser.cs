...
namespace XXG.ArticlePublisher.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ArticlePublisherDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ArticlePublisherEfCoreEntityExtensionMappings to extend the IdentityUser entity
